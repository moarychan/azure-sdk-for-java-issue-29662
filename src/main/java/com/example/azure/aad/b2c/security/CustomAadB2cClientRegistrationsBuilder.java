...
/**
 * This class provides a fluent builder API to help aid the instantiation of {@link Tuple2}
 ...
 */
public class CustomAadB2cClientRegistrationsBuilder {
     ...
     * @return the updated {@link CustomAadB2cClientRegistrationsBuilder}
     */
    public CustomAadB2cClientRegistrationsBuilder clientId(String clientId) {
     ...
     * @return the updated {@link CustomAadB2cClientRegistrationsBuilder}
     */
    public CustomAadB2cClientRegistrationsBuilder clientSecret(String clientSecret) {
     ...
     * @return the updated {@link CustomAadB2cClientRegistrationsBuilder}
     */
    public CustomAadB2cClientRegistrationsBuilder tenantId(String tenantId) {
     ...
     * @return the updated {@link CustomAadB2cClientRegistrationsBuilder}
     */
    public CustomAadB2cClientRegistrationsBuilder userNameAttributeName(String userNameAttributeName) {
     ...
     * @return the updated {@link CustomAadB2cClientRegistrationsBuilder}
     */
    public CustomAadB2cClientRegistrationsBuilder replyUrl(String replyUrl) {
     ...
     * @return the updated {@link CustomAadB2cClientRegistrationsBuilder}
     */
    public CustomAadB2cClientRegistrationsBuilder baseUri(String baseUri) {
     ...
     * @return the updated {@link CustomAadB2cClientRegistrationsBuilder}
     */
    public CustomAadB2cClientRegistrationsBuilder signInUserFlow(String signInUserFlow) {
     ...
     * @return the updated {@link CustomAadB2cClientRegistrationsBuilder}
     */
    public CustomAadB2cClientRegistrationsBuilder userFlows(String... userFlows) {
    ...
    public CustomAadB2cClientRegistrationsBuilder authorizationClient(String registrationId,
    ...
    /**
     * Creates an {@link Tuple2} based on the configuration in this builder.
     * @return an {@link Tuple2} created from the configurations in this builder.
     */
    public Tuple2<List<ClientRegistration>, Set<String>> build() {
        validateConfig();
        ...
        return Tuples.of(registrations, nonSignInClientRegistrationIds);
    }
    ...
    private ClientRegistration buildClientRegistration(String userFlow) {
        ...
        if (userFlow.equals(signInUserFlow)) {
            ...
            providerConfigurationMetadata.put("end_session_endpoint", CustomAadB2cUrl.getEndSessionUrl(baseUri, userFlow));
        }
