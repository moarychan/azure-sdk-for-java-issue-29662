 ...
 */
public class CustomAadB2cClientRegistrationRepository implements ClientRegistrationRepository, Iterable<ClientRegistration> {

    private final InMemoryClientRegistrationRepository delegate;

    private final Set<String> nonSignInClientRegistrationIds;

    public CustomAadB2cClientRegistrationRepository(List<ClientRegistration> clientRegistrations,
